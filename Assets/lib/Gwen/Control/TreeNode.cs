...
namespace Gwen.Control
{
    ...
    public class TreeNode : Base
    {
        ...
        { 
            add {
                m_Title.Clicked += delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
            }
            remove {
                m_Title.Clicked -= delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
            }
        ...
        { 
            add {
				if (value != null) {
                    m_Title.DoubleClicked += delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
				}
            }
            remove {
                m_Title.DoubleClicked -= delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
		...
		public override event GwenEventHandler<ClickedEventArgs> RightClicked {
			add {
                m_Title.RightClicked += delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
			}
			remove {
                m_Title.RightClicked -= delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
			}
		...
		public override event GwenEventHandler<ClickedEventArgs> DoubleRightClicked {
			add {
				if (value != null) {
                    m_Title.DoubleRightClicked += delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
				}
			}
			remove {
                m_Title.DoubleRightClicked -= delegate(Base sender, ClickedEventArgs args) { new ClickedEventArgs(args.X, args.Y, args.MouseDown); };
