...
namespace Gwen.Skin
{
    ...
    public class TexturedBase : Skin.Base
    {
        ...
        public override void DrawButton(Control.Base control, bool depressed, bool hovered, bool disabled)
        {
            if (disabled)
            {
                Textures.Input.Button.Disabled.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            if (depressed)
            {
                Textures.Input.Button.Pressed.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            if (hovered)
            {
                Textures.Input.Button.Hovered.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            Textures.Input.Button.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }

        public override void DrawMenuRightArrow(Control.Base control)
        {
            Textures.Menu.RightArrow.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }

        public override void DrawMenuItem(Control.Base control, bool submenuOpen, bool isChecked)
        {
            if (submenuOpen || control.IsHovered)
                Textures.Menu.Hover.Draw(Renderer, control.RenderBounds, control.RenderColor);

            if (isChecked)
                Textures.Menu.Check.Draw(Renderer, new Rectangle(control.RenderBounds.X + 4, control.RenderBounds.Y + 3, 15, 15), control.RenderColor);
        }

        public override void DrawMenuStrip(Control.Base control)
        {
            Textures.Menu.Strip.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawMenu(Control.Base control, bool paddingDisabled)
        {
            if (!paddingDisabled)
            {
                Textures.Menu.BackgroundWithMargin.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            Textures.Menu.Background.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawShadow(Control.Base control)
        {
            ...
            r.Width += 10;
            r.Height += 10;
            Textures.Shadow.Draw(Renderer, r, control.RenderColor);
        }
        ...
        public override void DrawRadioButton(Control.Base control, bool selected, bool depressed)
        {
            if (selected)
            {
                if (control.IsDisabled)
                    Textures.RadioButton.Disabled.Checked.Draw(Renderer, control.RenderBounds, control.RenderColor);
                else
                    Textures.RadioButton.Active.Checked.Draw(Renderer, control.RenderBounds, control.RenderColor);
            }
            else
            {
                if (control.IsDisabled)
                    Textures.RadioButton.Disabled.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
                else
                    Textures.RadioButton.Active.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
            }
        }
        ...
        public override void DrawCheckBox(Control.Base control, bool selected, bool depressed)
        {
            ...
            {
                if (control.IsDisabled)
                    Textures.CheckBox.Disabled.Checked.Draw(Renderer, control.RenderBounds, control.RenderColor);
                else
                    Textures.CheckBox.Active.Checked.Draw(Renderer, control.RenderBounds, control.RenderColor);
            }
            else
            {
                if (control.IsDisabled)
                    Textures.CheckBox.Disabled.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
                else
                    Textures.CheckBox.Active.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
            }
        }
        ...
        public override void DrawTextBox(Control.Base control)
        {
            if (control.IsDisabled)
            {
                Textures.TextBox.Disabled.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (control.HasFocus)
                Textures.TextBox.Focus.Draw(Renderer, control.RenderBounds, control.RenderColor);
            else
                Textures.TextBox.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawTabButton(Control.Base control, bool active, Pos dir)
        {
            ...
            if (dir == Pos.Top)
            {
                Textures.Tab.Top.Inactive.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            if (dir == Pos.Left)
            {
                Textures.Tab.Left.Inactive.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            if (dir == Pos.Bottom)
            {
                Textures.Tab.Bottom.Inactive.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            if (dir == Pos.Right)
            {
                Textures.Tab.Right.Inactive.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
        }
        ...
        private void DrawActiveTabButton(Control.Base control, Pos dir)
        {
            if (dir == Pos.Top)
            {
                Textures.Tab.Top.Active.Draw(Renderer, control.RenderBounds.Add(new Rectangle(0, 0, 0, 8)), control.RenderColor);
                return;
            }
            if (dir == Pos.Left)
            {
                Textures.Tab.Left.Active.Draw(Renderer, control.RenderBounds.Add(new Rectangle(0, 0, 8, 0)), control.RenderColor);
                return;
            }
            if (dir == Pos.Bottom)
            {
                Textures.Tab.Bottom.Active.Draw(Renderer, control.RenderBounds.Add(new Rectangle(0, -8, 0, 8)), control.RenderColor);
                return;
            }
            if (dir == Pos.Right)
            {
                Textures.Tab.Right.Active.Draw(Renderer, control.RenderBounds.Add(new Rectangle(-8, 0, 8, 0)), control.RenderColor);
                return;
            }
        }
        ...
        {
            Textures.Tab.Control.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }

        public override void DrawTabTitleBar(Control.Base control)
        {
            Textures.Tab.HeaderBar.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }

        public override void DrawWindow(Control.Base control, int topHeight, bool inFocus)
        {
            if (inFocus)
                Textures.Window.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
            else
                Textures.Window.Inactive.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        {
            if (horizontal)
                Textures.Scroller.TrackH.Draw(Renderer, control.RenderBounds, control.RenderColor);
            else
                Textures.Scroller.TrackV.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawScrollBarBar(Control.Base control, bool depressed, bool hovered, bool horizontal)
        {
            if (!horizontal)
            {
                if (control.IsDisabled)
                {
                    Textures.Scroller.ButtonV_Disabled.Draw(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }

                if (depressed)
                {
                    Textures.Scroller.ButtonV_Down.Draw(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }

                if (hovered)
                {
                    Textures.Scroller.ButtonV_Hover.Draw(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }

                Textures.Scroller.ButtonV_Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (control.IsDisabled)
            {
                Textures.Scroller.ButtonH_Disabled.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (depressed)
            {
                Textures.Scroller.ButtonH_Down.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (hovered)
            {
                Textures.Scroller.ButtonH_Hover.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            Textures.Scroller.ButtonH_Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawProgressBar(Control.Base control, bool horizontal, float progress)
        {
            ...
            if (horizontal)
            {
                Textures.ProgressBar.Back.Draw(Renderer, rect, control.RenderColor);
                rect.Width = (int) (rect.Width*progress);
                Textures.ProgressBar.Front.Draw(Renderer, rect, control.RenderColor);
            }
            else
            {
                Textures.ProgressBar.Back.Draw(Renderer, rect, control.RenderColor);
        ...
        {
            Textures.Input.ListBox.Background.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawListBoxLine(Control.Base control, bool selected, bool even)
        {
            if (selected)
            {
                if (even)
                {
                    Textures.Input.ListBox.EvenLineSelected.Draw(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }
                Textures.Input.ListBox.OddLineSelected.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            
            if (control.IsHovered)
            {
                Textures.Input.ListBox.Hovered.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (even)
            {
                Textures.Input.ListBox.EvenLine.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            Textures.Input.ListBox.OddLine.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawComboBox(Control.Base control, bool down, bool open)
        {
            if (control.IsDisabled)
            {
                Textures.Input.ComboBox.Disabled.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (down || open)
            {
                Textures.Input.ComboBox.Down.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
            ...
            Textures.Input.ComboBox.Normal.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        {
            Textures.Tooltip.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawScrollButton(Control.Base control, Pos direction, bool depressed, bool hovered, bool disabled)
        {
            ...
            if (disabled)
            {
                Textures.Scroller.Button.Disabled[i].Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (depressed)
            {
                Textures.Scroller.Button.Down[i].Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (hovered)
            {
                Textures.Scroller.Button.Hover[i].Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            Textures.Scroller.Button.Normal[i].Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawComboBoxArrow(Control.Base control, bool hovered, bool down, bool open, bool disabled)
        {
            if (disabled)
            {
                Textures.Input.ComboBox.Button.Disabled.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (down || open)
            {
                Textures.Input.ComboBox.Button.Down.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (hovered)
            {
                Textures.Input.ComboBox.Button.Hover.Draw(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }
        ...
        public override void DrawNumericUpDownButton(Control.Base control, bool depressed, bool up)
        {
            if (up)
            {
                if (control.IsDisabled)
                {
                    Textures.Input.UpDown.Up.Disabled.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }

                if (depressed)
                {
                    Textures.Input.UpDown.Up.Down.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }

                if (control.IsHovered)
                {
                    Textures.Input.UpDown.Up.Hover.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                    return;
                }

                Textures.Input.UpDown.Up.Normal.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (control.IsDisabled)
            {
                Textures.Input.UpDown.Down.Disabled.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (depressed)
            {
                Textures.Input.UpDown.Down.Down.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            if (control.IsHovered)
            {
                Textures.Input.UpDown.Down.Hover.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
                return;
            }

            Textures.Input.UpDown.Down.Normal.DrawCenter(Renderer, control.RenderBounds, control.RenderColor);
        }

        public override void DrawStatusBar(Control.Base control)
        {
            Textures.StatusBar.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        {
            Textures.Tree.Background.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        ...
        public override void DrawTreeNode(Control.Base ctrl, bool open, bool selected, int labelHeight, int labelWidth, int halfWay, int lastBranch, bool isRoot)
        {
            if (selected)
            {
                Textures.Selection.Draw(Renderer, new Rectangle(17, 0, labelWidth + 2, labelHeight - 1), ctrl.RenderColor);
            }
        ...
        {
            Textures.CategoryList.Outer.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }

        public override void DrawCategoryInner(Control.Base control, bool collapsed)
        {
            if (collapsed)
                Textures.CategoryList.Header.Draw(Renderer, control.RenderBounds, control.RenderColor);
            else
                Textures.CategoryList.Inner.Draw(Renderer, control.RenderBounds, control.RenderColor);
        }
        #endregion
    }
}
